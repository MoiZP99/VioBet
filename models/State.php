...
class State
{
  ...
  {
    $query = "SELECT Id, Estado FROM estado_emprendedor WHERE Estado = 'Activo' OR Estado = 'Inactivo'";
  ...
  {
    $query = "SELECT Id, Estado FROM estado_emprendedor WHERE Estado LIKE 'Solicitud'";
