                    ...
                    <a href="topics-detail.html">
                        <div class="d-flex">
                            <div>
                                ...
                                <p class="mb-0">Realice un control del movimiento de los animales según las agrupaciones por edad y el manejo del pasto.</p>
                            </div>
                ...
                <div class="custom-block custom-block-overlay">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="custom-block-overlay-text d-flex">
                            <div>
                                <h5 class="text-white mb-2">Administración</h5>
